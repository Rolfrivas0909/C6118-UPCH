...
####**Temperatura superficial del mar promedio durante los años 1959-2005 y anomalia para a?o 1991.**
```{r}
#variable sst
nc_sst=nc_open("datos/sst.nc4")
sst = ncvar_get(nc_sst, "to")
...
No hubo anomalía de la temperatura superficial del mar en las zonas central y norte del pacífico frente a Perú, sin embargo se puede observar una pequeña anomal?a positiva en la zona sur (fig 3).
...
#Grafico promedio de a?o SSS 1991
...
```
  ...
  **Figura 5**: Promedio de la productividad de fitoplancton grande y pequeño durante los a?os 1959-2005 y la anomal?a durante el año 1991.  
...
La temperatura y productividad fueron normales durante el año con un pico durante verano y una disminución durante invierno (Moran,2000). La salinidad también fue una variable normal, ya que tiende a disminuir con un aumento de la temperatura superficial del mar durante verano.
...
-(Morán O. 2000. Caracterásticas del ambiente marino frente a la costa peruana. Bol. Inst. Mar Perú 19(1-2):179-204.)[http://www.imarpe.gob.pe/paita/publicaciones/caract_del_amb_marino.pdf]
